...
class DestructibleMoppUtility 
{
	public:
		...
		static void collectAllConvexChildShapesWithinRadius( const hkpBvTreeShape* treeShape, hkVector4Parameter sphereCenterInShapeSpace, hkReal radius, hkpCollisionInput& collisionInput,
