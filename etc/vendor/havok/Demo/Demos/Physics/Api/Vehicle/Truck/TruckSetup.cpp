...
void TruckSetup::buildVehicle(hkpWorld* world, hkpVehicleInstance& vehicle )
{
	//
...
void TruckSetup::setupVehicleData( hkpWorld* world, hkpVehicleData& data )
{
...
void TruckSetup::setupWheelCollide( hkpWorld* world, const hkpVehicleInstance& vehicle, hkpVehicleRaycastWheelCollide& wheelCollide )
{
