	...
	m_packfileData( HK_NULL )
{
	...
	hkString fileNameSphereShape("Common/Api/Serialize/SerializeWithoutMetadata/withoutMetaDataShapeShape");
	hkString fileNameRigidBody("Common/Api/Serialize/SerializeWithoutMetadata/withoutMetaDataRigidBody");
	hkString fileNameWorld("Common/Api/Serialize/SerializeWithoutMetadata/withoutMetaDataWorld");
