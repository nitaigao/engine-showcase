...
class hkpEntity : public hkpWorldObject
{
    ...
    public:     void* m_breakOffPartsUtil; //+serialized(false)
                ...
                class hkdBreakableBody* m_breakableBody; //+nosave
	...
	public:
			...
			/// The collection of handles (reference frames) that are attached to the entity.  You should
			/// leave an extra reference count on this because ~hkpEntity() will call removeReference() on it.
