// following 8 lines added by RWH force using ticpp and to suppress warnings from VS.NET2005
...
#else
   disable tinystr - will always use the STL - RWH
   if you get an error at this line, be sure TIXML_USE_TICPP is defined above
//#  include "tinystr.h"
