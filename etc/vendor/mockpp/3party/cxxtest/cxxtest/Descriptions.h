...
class TestSuite;
    ...
    class CXXTEST_API_DECL0 TestDescription : public Link
    {
    public:
    ...
    class CXXTEST_API_DECL0 SuiteDescription : public Link
    {
    public:
    ...
    class CXXTEST_API_DECL0 WorldDescription : public Link
    {
    public:
