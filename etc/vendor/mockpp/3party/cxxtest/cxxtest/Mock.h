...
#define __CXXTEST_MOCK__PROTOTYPE( MOCK, TYPE, NAME, ARGS, REAL, CALL ) \
    CXXTEST_NS_START TYPE NAME ARGS; CXXTEST_NS_END
...
#define __CXXTEST_MOCK__CLASS_DECLARATION( MOCK, TYPE, NAME, ARGS, REAL, CALL ) \
    CXXTEST_NS_START \
        class Base_##MOCK : public CXXTEST_NS::Link \
        { \
        public: \
            Base_##MOCK(); \
            ~Base_##MOCK(); \
...
#define __CXXTEST_MOCK__COMMON_CLASS_IMPLEMENTATION( MOCK, NAME ) \
    CXXTEST_NS_START \
         \
        CXXTEST_NS::List Base_##MOCK::_list = { 0, 0 }; \
         \
...
//
#define CXXTEST_MOCK( MOCK, TYPE, NAME, ARGS, REAL, CALL ) \
    CXXTEST_NS_START TYPE NAME ARGS { return REAL CALL; } CXXTEST_NS_END

#define CXXTEST_MOCK_VOID( MOCK, NAME, ARGS, REAL, CALL ) \
    CXXTEST_NS_START void NAME ARGS { REAL CALL; } CXXTEST_NS_END
