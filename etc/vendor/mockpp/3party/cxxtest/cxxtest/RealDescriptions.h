...
CXXTEST_NS_START
    class CXXTEST_API_DECL0 RealTestDescription : public TestDescription
    {
    public:
        RealTestDescription();
    ...
    class CXXTEST_API_DECL0 RealSuiteDescription : public SuiteDescription
    {
    public:
    ...
    class CXXTEST_API_DECL0 StaticSuiteDescription : public RealSuiteDescription
    {
    public:
    ...
    class CXXTEST_API_DECL0 CommonDynamicSuiteDescription : public RealSuiteDescription
    {
    public:
    ...
    class CXXTEST_API_DECL0 RealWorldDescription : public WorldDescription
    {
    public:
        static List &suites();
